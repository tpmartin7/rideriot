...
locations = {
  new_spitalfields_market: Location.new(
    ...
    cycle_route_id: CycleRoute.find_by(name: 'Victoria Park').id
  ),
  ...
  spitalfields: Location.new(
    ...
    cycle_route_id: CycleRoute.find_by(name: 'Regents Canal').id
  ),
  bloomsbury_house: Location.new(
    ...
    cycle_route_id: CycleRoute.find_by(name: 'CS1').id
  ),
  ...
  spit: Location.new(
    ...
    cycle_route_id: CycleRoute.find_by(name: 'Tower of London East').id
  ),
  ...
  london_eye: Location.new(
    ...
    cycle_route_id: CycleRoute.find_by(name: 'Battersea Park').id
  ),
  globe: Location.new(
  ...
  mile_end: Location.new(
    ...
    cycle_route_id: CycleRoute.find_by(name: 'Limehouse Basin').id
  ),
  ...
  battersea_station: Location.new(
    ...
    cycle_route_id: CycleRoute.find_by(name: 'Big Ben').id
  ),
  ...
  parkland: Location.new(
    ...
    cycle_route_id: CycleRoute.find_by(name: 'Finsbury Park').id
  ),
  cir1: Location.new(
    name: 'Interval 1',
    address: "55 Park Rd, London NW1 6XU",
    description: "First checkpoint. Time to blitz the next one!",
    cycle_route_id: CycleRoute.find_by(name: 'Regents Park Circular').id
  ),
  circ2: Location.new(
    name: 'Interval 2',
  ...
  thames: Location.new(
    ...
    cycle_route_id: CycleRoute.find_by(name: 'Tower of London West').id
  ),
  ...
  kensington: Location.new(
    ...
    cycle_route_id: CycleRoute.find_by(name: 'Hyde Park Loop').id
  ),
